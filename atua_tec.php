  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <form class="form-inline" role="form"   method="POST" action="atua_tec.php">
  ...
  Procurar TÉC
      ...
      -->
                ...
                { 
                  ...
                  $sql = mysql_query ("select  * from usuario where id = '$mat'" );
                }  
      ...
      <div class="row " >
        <div class="col-md-12">
          ...
          <div class="tile">
          <h3 class="tile-title">Atualiza TÉCNICO</h3>
            ...
            <div class="bs-component">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade active show" id="home">
                     <form method="post"  action="enviar_atua_tec.php">
                                <div class="form-group"><br><br>
                                    <label for="exampleInputEmail1">ID</label>
                                    <input class="form-control"  required id="exampleInputEmail1" name="id"  value="<?php echo  $mat; ?>" readonly type="text" aria-describedby="emailHelp" >
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">NOME</label>
                                    <input class="form-control"  required id="exampleInputEmail1" name="nome"  value="<?php echo  $nome; ?>" readonly type="text" aria-describedby="emailHelp" >
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">LOCALIDADE</label>
                                    <input class="form-control"  required id="exampleInputEmail1" name="localidade"  value="<?php echo  $localidade; ?>" readonly type="text" aria-describedby="emailHelp" >
                                </div>

                                <div class="form-group">
                                    <label for="exampleFormControlSelect1">NOME GA</label>
                                    <select  class="form-control" id="exampleFormControlSelect1" name="id_ga" >
                                       
                                      <option value="<?php echo  $nome_ga; ?>"><?php echo  $nome_ga; ?></option>
                                      <option value="380754">JUNIOMAR ALEX MOCHNACZ</option>
                                      <option value="381030">CLEOMAR APARECIDO BISCHOFF</option>
                                      <option value="382473">ENIR RODRIGUES</option>
                                      <option value="383054">JOSE LUIS TRINDADE</option>
                                      <option value="383056">ANDERSON FELIPE FERRI</option>
                                      <option value="387358">ALISSON SQUINZANI</option>
