...
if ($_SESSION['acesso'] == 'GA')
{
  ...
  $sql = mysql_query ("select * from cliente where   cliente.id_ga  = '".$_SESSION['id']."' and data_final >= '$data_atual' and cliente.data_ult_ret < '$data_atual' and data_rep < '$data_atual' and data_rep !='$data_atual'  group by cliente.protocolo" );
...
{
    $sql = mysql_query ("select * from cliente where   cliente.id_tec  = '".$_SESSION['id']."' and data_final >= '$data_atual' and cliente.data_ult_ret < '$data_atual' and data_rep !='$data_atual' group by cliente.protocolo" );
